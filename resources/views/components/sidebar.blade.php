<div class="w-100">
    <div class="d-flex align-items-center justify-content-between">
        <img class="btn-menu-show px-3 py-2" src="{{ asset('assets/images/icons/menu.png') }}" alt="Menu">
        @if ($theme == 'dark')
            <img class="items-sidebar-end btn-menu-theme px-3 py-2 ms-3" src="{{ asset('assets/images/icons/dark.png') }}" alt="Tema escuro" wire:click="changeTheme('light')">
        @else
            <img class="items-sidebar-end btn-menu-theme px-3 py-2 ms-3" src="{{ asset('assets/images/icons/light.png') }}" alt="Tema claro" wire:click="changeTheme('dark')">
        @endif
    </div>
</div>
...
<div class="w-100">
    <a class="items-sidebar px-3 py-2 d-flex align-items-center" href="https://www.instagram.com/yslandio" target="_blank">
    ...
    <a class="items-sidebar px-3 py-2 d-flex align-items-center" href="https://www.linkedin.com/yslandio" target="_blank">
